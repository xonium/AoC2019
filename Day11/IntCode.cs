...
namespace Day11
{
    ...
    {
        public static (long, int, int) ThermalEnvironmentSupervisionTerminal(List<long> intValues, int input, bool trace = false, int instructionPointer = 0, int relativeBase = 0)
        {
            var exit = false;
            ...
            return (-1, instructionPointer, relativeBase);
        }
